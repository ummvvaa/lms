...
const GUIDES: Record<Role, Guide> = {
  ...
  curator: {
    title: 'С чего начать',
    steps: [
      { title: 'Проверьте свои группы', text: 'Группы назначает администратор. Если группы нет в списке — напишите ему.' },
      {
      ...
      { title: 'Дальше — очередь', text: 'Подтверждения баллов и документов ваших групп появятся здесь в следующей фазе.' },
    ],
