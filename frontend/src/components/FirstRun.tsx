...
const GUIDES: Record<Role, Guide> = {
  ...
  curator: {
    ...
    steps: [
      {
        title: 'Проверьте свои группы',
        text: 'Группы назначает администратор. Если группы нет в списке — напишите ему.',
      },
      {
        title: 'Откройте карточку ученика',
        text: 'Карточка целиком: все домены, история правок. Данные за ученика вы не вносите — подтверждаете.',
      },
      {
        title: 'Дальше — очередь',
        text: 'Подтверждения баллов и документов ваших групп — в очереди; переданное владельцу домена видно под ней.',
      },
    ],
    action: { label: 'Открыть кабинет', path: '/dashboard' },
  },
  admin: {
    title: 'Три шага, чтобы начать',
    steps: [
