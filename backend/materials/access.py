...
def has_access(user) -> bool:
    ...
    и ученик, отобранный в олимпиадную группу. Остальным директорам там
    смотреть нечего: это разбор заданий олимпиад, а не сведения об
    учениках. С фазы 68 раздел видит и администратор: он правит все
    домены, и отбор в олимпиадную группу — тоже его право.
    """
