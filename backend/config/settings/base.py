...
# --- Категории результата подбора (фаза 40) --------------------------------
#: Границы по проценту соответствия: ниже reach — dream. Это категории
#: соответствия требованиям, а не шансы (инвариант №11). Конфигурируемы.
MATCH_TIERS = {
    "safety": float(env("MATCH_TIER_SAFETY", "90")),
    "match": float(env("MATCH_TIER_MATCH", "70")),
    "reach": float(env("MATCH_TIER_REACH", "45")),
}
